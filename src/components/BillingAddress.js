    ...
    <div className="jadu">
        ...
        <form action="https://httpbin.org/post" class="form" method="POST">
          <div>
            ...
            <div class="card">
              <address>
                RAHUL MODI
                <br />
                403 Oakland Ave Street, A city, Faridabad, 32104,
                <br />
                United States of DELHI
              </address>
            </div>
          </div>
          ...
          <div>
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>Discount 10%</td>
                  <td align="right">-₹{(total * 0.1).toFixed(2)}</td>
                </tr>
                <tr>
                  <td>Price Total</td>
          ...
          <div>
            <NavLink to="/orderplaced">
              <button class="button button--full" type="submit" onClick={Empty}>
                <svg class="icon">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" style={{ display: "none" }}>
        ...
        <symbol id="icon-paypal" viewBox="0 0 491.2 491.2">
          ...
          />
          <path
            d="m275.249 0h-152c-10.4 0-20 8-21.6 18.4l-36.8 230.4 246.4-246.4c-11.2-1.6-23.2-2.4-36-2.4z"
            fill="#2a4dad"
          />
          <path
          ...
          />
          <path
            d="m50.449 436.8h94.4l23.2-145.6c0-2.4.8-4 1.6-5.6l-131.2 131.2-.8 4.8c-.8 8 4.8 15.2 12.8 15.2z"
            fill="#232c65"
          />
          <path
            d="m246.449 0h-123.2c-3.2 0-5.6.8-8 1.6l-12 12c-.8 1.6-1.6 3.2-1.6 4.8l-24 150.4z"
            fill="#436bc4"
          />
          <path
            d="m450.449 232.8c2.4-12 3.2-23.2 3.2-34.4l-156 156c76-.8 135.2-32 152.8-121.6z"
            fill="#0cb2ed"
          />
          <path
            d="m248.849 471.2 12.8-80-100 100h68c9.6 0 17.6-7.2 19.2-16z"
            fill="#0cb2ed"
          />
        ...
        <symbol id="icon-visa" viewBox="0 0 504 504">
          ...
          />
          <path
            d="m111.2 281.2-4-20.8c-7.2-24-30.4-50.4-56-63.2l36 128h43.2l64.8-144h-43.2z"
            fill="#3c58bf"
          />
          <path
            d="m111.2 281.2-4-20.8c-7.2-24-30.4-50.4-56-63.2l36 128h43.2l64.8-144h-35.2z"
            fill="#293688"
          />
          <path
            d="m0 180.4 7.2 1.6c51.2 12 86.4 42.4 100 78.4l-14.4-68c-2.4-9.6-9.6-12-18.4-12z"
            fill="#ffbc00"
          />
          <path
            d="m0 180.4c51.2 12 93.6 43.2 107.2 79.2l-13.6-56.8c-2.4-9.6-10.4-15.2-19.2-15.2z"
            fill="#f7981d"
          />
          <path
            d="m0 180.4c51.2 12 93.6 43.2 107.2 79.2l-9.6-31.2c-2.4-9.6-5.6-19.2-16.8-23.2z"
            fill="#ed7c00"
          />
          <g fill="#051244">
